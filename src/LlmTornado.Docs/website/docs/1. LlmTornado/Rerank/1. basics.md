...
#### Cohere
- **rerank-v4.0-pro** - Highest quality multilingual reranker (32K context)
- **rerank-v4.0-fast** - Low-latency multilingual reranker (32K context)
- **rerank-v3.5** - Multilingual reranker (4K context)
- **rerank-multilingual-v3.0** - Supports 100+ languages
- **rerank-english-v3.0** - Optimized for English

#### Voyage AI
- **rerank-3** - Highest accuracy (preview)
- **rerank-3-lite** - Fast and cost-effective (preview)
- **rerank-2.5** - High-quality reranking model
- **rerank-2.5-lite** - Faster, lighter reranking model
- **rerank-2** - Previous-generation high-quality reranker
...
### RerankModel
- `Cohere.Gen4.Pro` - Cohere Rerank 4 Pro
- `Cohere.Gen4.Fast` - Cohere Rerank 4 Fast
- `Cohere.Gen3.V35` - Cohere Rerank 3.5
- `Cohere.Gen3.Multilingual` - Cohere multilingual v3
- `Cohere.Gen3.English` - Cohere English v3
- `Voyage.Gen3.Rerank3` - Voyage rerank-3
- `Voyage.Gen3.Rerank3Lite` - Voyage rerank-3-lite
- `Voyage.Gen25.Rerank25` - Voyage rerank-2.5
