...
- **voyage-4** - Balanced quality and performance; shared Voyage 4 embedding space
- **voyage-4-lite** - Lowest latency and cost in the Voyage 4 series
- **voyage-code-4** - Code retrieval and coding-agent use cases
- **voyage-context-4** - Contextualized chunk embeddings with backend auto-chunking
- **voyage-multimodal-3.5** - Text, image, and video embeddings with Matryoshka dimensions
...
```csharp
EmbeddingResult? result = await api.Embeddings.CreateEmbedding(
    EmbeddingModel.Voyage.Gen4.Standard, 
    "lorem ipsum", 
    256, 
...
- `Voyage.Gen4.Standard` - Voyage 4
- `Voyage.Gen4.Large` - Voyage 4 Large
- `Voyage.Gen4.Lite` - Voyage 4 Lite
- `Voyage.Gen4.Code` - Voyage Code 4
